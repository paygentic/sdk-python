...
SchemasPaymentSessionObject = Literal["payment_session",]


SchemasPaymentSessionStatus = Union[
    Literal[
        "pending",
        "processing",
        "completed",
...
class SchemasPaymentSessionTypedDict(TypedDict):
...
class SchemasPaymentSession(BaseModel):
    object: SchemasPaymentSessionObject
...
try:
    SchemasPaymentSession.model_rebuild()
except NameError:
    pass

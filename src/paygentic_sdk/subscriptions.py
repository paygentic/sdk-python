...
class Subscriptions(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        :param prefund_amount: Deprecated. This field is ignored and has no effect.
        :param minimum_account_balance: Deprecated. This field is ignored and has no effect.
    ...
    def update_subscription(
        ...
        *,
        id: str,
        ending_at: Optional[datetime] = None,
        status: Optional[models.UpdateSubscriptionStatus] = None,
        ...
        :param tax_exempt: When true, forces tax rate to 0%.
        :param minimum_account_balance: Deprecated. This field is ignored and has no effect.
    ...
    def reconcile_subscription_features(
        self,
        *,
        id: str,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SubscriptionReconciliation:
        r"""Reconcile Features
        ...
        :param id: The subscription ID
        :param dry_run: Preview the outcome without creating any entitlement, grant, or line item.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.ReconcileSubscriptionFeaturesRequest(
            id=id,
            request_body=models.ReconcileSubscriptionFeaturesRequestBody(
                dry_run=dry_run,
            ),
        )
        ...
        req = self._build_request(
            method="POST",
            path="/v0/subscriptions/{id}/reconciliations",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.ReconcileSubscriptionFeaturesRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="reconcileSubscriptionFeatures",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, ["200", "201"], "application/json"):
            return unmarshal_json_response(models.SubscriptionReconciliation, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.BadRequestUnion, http_res)
            raise errors.BadRequest(response_data, http_res)
        if utils.match_response(http_res, ["401", "403", "404"], "application/json"):
    ...
    async def reconcile_subscription_features_async(
        self,
        *,
        id: str,
        dry_run: Optional[bool] = False,
    ...
    def list_subscription_adjustments(
        self,
        *,
        id: str,
        ...
        :param id: The subscription ID
        :param limit: Number of adjustments to return
        :param offset: Number of adjustments to skip
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.ListSubscriptionAdjustmentsRequest(
            id=id,
            limit=limit,
            offset=offset,
        )
        ...
        req = self._build_request(
            method="GET",
            path="/v0/subscriptions/{id}/adjustments",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="listSubscriptionAdjustments",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SubscriptionAdjustmentsResponse, http_res
            )
        if utils.match_response(http_res, ["401", "403", "404"], "application/json"):
            response_data = unmarshal_json_response(errors.ErrorData, http_res)
            raise errors.Error(response_data, http_res)
    ...
    async def list_subscription_adjustments_async(
        self,
        *,
        id: str,
        limit: Optional[str] = "10",
    ...
    def create_subscription_adjustment(
        self,
        *,
        id: str,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.create_subscription_adjustment_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="createSubscriptionAdjustment",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def create_subscription_adjustment_async(
        self,
        *,
        id: str,
        type_: models.CreateSubscriptionAdjustmentRequestType,
    ...
    def delete_subscription_adjustment(
        self,
        *,
        id: str,
        adjustment_id: str,
        ...
        request = models.DeleteSubscriptionAdjustmentRequest(
            id=id,
        ...
        req = self._build_request(
            method="DELETE",
            path="/v0/subscriptions/{id}/adjustments/{adjustmentId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="deleteSubscriptionAdjustment",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def delete_subscription_adjustment_async(
        self,
        *,
        id: str,
        adjustment_id: str,

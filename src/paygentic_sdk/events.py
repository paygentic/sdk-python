...
class Events(BaseSDK):
    ...
    def ingest(
        ...
        *,
        ...
        :param type: CloudEvents type. Must match an eventType configured on a BillableMetric.
        :param source: Event source URI identifying the application.
        :param subject: Customer or entity ID this event relates to.
        :param data: Event payload containing the metering data.
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return unmarshal_json_response(models.EventResponse, http_res)

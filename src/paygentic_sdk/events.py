...
class Events(BaseSDK):
    ...
    def ingest(
        self,
        *,
        request: Union[models.IngestEventRequest, models.IngestEventRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.IngestEventRequest)
        request = cast(models.IngestEventRequest, request)

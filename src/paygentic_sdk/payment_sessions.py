...
class PaymentSessions(BaseSDK):
    ...
    def list_payment_sessions(
        ...
        *,
        request: Union[
            models.ListPaymentSessionsRequest,
            models.ListPaymentSessionsRequestTypedDict,
        ] = models.ListPaymentSessionsRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ListPaymentSessionsResponse:
        r"""List
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListPaymentSessionsRequest)
        request = cast(models.ListPaymentSessionsRequest, request)

        req = self._build_request(
            method="GET",
            path="/v0/paymentSessions",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="listPaymentSessions",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListPaymentSessionsResponse, http_res)
    ...
    async def list_payment_sessions_async(
        self,
        *,
        request: Union[
            models.ListPaymentSessionsRequest,

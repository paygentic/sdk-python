...
<!-- UsageSnippet language="python" operationID="createSubscriptionAdjustment" method="post" path="/v0/subscriptions/{id}/adjustments" example="percentageDiscount" -->
```python
import os
from paygentic_sdk import Paygentic
from paygentic_sdk.utils import parse_datetime
...
with Paygentic(
    ...
    res = paygentic.subscriptions.create_subscription_adjustment(id="<id>", create_subscription_adjustment_request={
        "type": "percentageDiscount",
        "percentage_discount": "0.35",
        "effective_from": parse_datetime("2026-01-01T00:00:00Z"),
        "effective_to": None,
        "description": "FY26 Growth",
        "idempotency_key": "adj_fy26_growth_001",
    })
...
<!-- UsageSnippet language="python" operationID="createSubscriptionAdjustment" method="post" path="/v0/subscriptions/{id}/adjustments" example="usageDiscount" -->
```python
import os
from paygentic_sdk import Paygentic
from paygentic_sdk.utils import parse_datetime
...
with Paygentic(
    ...
    res = paygentic.subscriptions.create_subscription_adjustment(id="<id>", create_subscription_adjustment_request={
        ...
        "effective_from": parse_datetime("2026-03-01T00:00:00Z"),
        "effective_to": parse_datetime("2026-04-01T00:00:00Z"),
        "description": "March outage — bad events",
        "idempotency_key": "adj_march_outage_001",
    })

...
| `group_by`                                                                                                                                                              | Dict[str, *str*]                                                                                                                                                        | :heavy_minus_sign:                                                                                                                                                      | Map of dimension name to JSONPath for group-by queries. Each value must start with `$.` (example: `$.region`). Only valid for metered costs.                            |
...
| `value_property`                                                                                                            | *OptionalNullable[str]*                                                                                                     | :heavy_minus_sign:                                                                                                          | Updated JSONPath for value extraction. Must start with `$.` (example: `$.amount` or `$.payload.bytes`). Metered costs only. |
| `group_by`                                                                                                                  | Dict[str, *str*]                                                                                                            | :heavy_minus_sign:                                                                                                          | Updated group-by dimension map. Each value must start with `$.` (example: `$.region`). Metered costs only.                  |
| `retries`                                                                                                                   | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                            | :heavy_minus_sign:                                                                                                          | Configuration to override the default retry behavior of the client.                                                         |
